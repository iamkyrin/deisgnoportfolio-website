...
import illImg from "/public/assets/home/desktop/illustration-resourceful.svg";
  ...
  return (
    <div>
      <div className="flex justify-center items-center">
        <div
          className="grid sm:grid-cols-3 grid-cols-1 gap-20 max-w-full 2xl:w-[80rem] lg:w-[80rem]
                md:w-[40rem]"
        >
          <div className="flex justify-center items-center flex-col">
            <img src={passionateImg}></img>
            <div className="flex justify-center items-center flex-col">
              <h1 className="jost400 mt-10">P A S S I O N A T E</h1>
              <p className="jost text-gray-700 text-center mt-10">
          ...
          <div className="flex justify-center items-center flex-col">
            ...
            <div className="flex justify-center items-center flex-col">
              ...
              <p className="jost text-gray-700 text-center mt-10">
                ...
                collaboration. It guarantees superior results that fulfil our
                client's needs.
              </p>
            </div>
          </div>
