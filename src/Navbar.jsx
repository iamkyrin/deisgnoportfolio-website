...
return(
    <div className="flex justify-between 2xl:px-85 w-full mt-20">
        ...
        <div className="lg:hidden ml-20">
            <button className="2xl:hidden md:hidden sm:block" onClick={() => setOpen(!open)}>
                {open ? (
  ...
  {/* NAVBAR!!! */}
        ...
        <nav className="jost400 text-gray-500">
            ...
            <li><Link to = {'/about'} className="cursor-pointer">OUR COMPANY</Link></li>
            <li><Link to = {'/locations'} className="cursor-pointer">LOCATIONS</Link></li>
